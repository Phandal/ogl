 ...
 * bottom-left side of our triangle black? solution:
...
int main(void) {
  ...
  shader_t vertexShader =
      shader_load(GL_VERTEX_SHADER, "shaders/vertex_out.glsl");
  shader_t fragmentShader =
      shader_load(GL_FRAGMENT_SHADER, "shaders/fragment_in.glsl");
